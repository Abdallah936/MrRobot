...
import { post, API_URL } from "./action/BaseAction";
      ...
      >
        ...
        <div className="form-group">
          <input
            ...
            onChange={this.props.usernameHandleChange}
        ...
        <div className="form-group">
          <input
            ...
            onChange={this.props.passwordHandleChange}
            className="form-control"
  ...
  return {
    handleLoginClick: (user) => {
      ...
      return post(`${API_URL}/login`, user)
        ...
        .catch((err) => {
          console.log(
            "./src/pages/login.js => mapDispatchToProps => postLogin()",
            err
          );
        });
    },
