...
const Navbar1 = ({ sticky }) => (
  ...
  <li><a class="dropdown-item" href="id.dropdown">Regular link</a></li>
  <li><a class="dropdown-item active" href="id.dropdown" aria-current="true">Active link</a></li>
  <li><a class="dropdown-item" href="id.dropdown">Another link</a></li>
</ul>
</div> </Dropdown>
          <ul className="navbar--link">
