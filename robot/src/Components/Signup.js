...
import { get, API_URL } from "./action/BaseAction";
      ...
      >
        ...
        <div className="form-row">
          <div className="col-md-6">
            ...
            />
            <label className="form-control-gender" htmlFor="customRadioInline1">
              &nbsp;Male
            </label>
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input
              ...
              className="custom-control-input"
            />
            <label className="form-control-gender" htmlFor="customRadioInline2">
              &nbsp;Female
            </label>
          </div>
          <div className="form-group col-md-6">
  ...
  return {
    ...
    getCountries: () => {
      return get(`${API_URL}/countries`)
        ...
        .catch((err) => {
          console.log(
            "./src/pages/signup.js => mapDispatchToProps => getCountries()",
            err
          );
        });
    },
